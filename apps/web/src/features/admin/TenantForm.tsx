...
function Editor({ initial }: { initial: AdminTenant | null }) {
 ...
 <AdminField label="Brand colour" name="primaryColor" defaultValue={tenant?.primaryColor ?? ''} placeholder="#145C43" maxLength={7} hint="Optional six-digit hex colour; leave blank for the default." problem={request.feedback.problem} />
